...
if ($name == "") {
    ...
    $headers .= 'From:  Website <sayem.eesti@outlook.com>' . "\r\n";
    $headers .= 'cc: sayem.eesti@outlook.com' . "\r\n";
    $headers .= 'bcc: sayem.eesti@outlook.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f sayem.eesti@outlook.com');
